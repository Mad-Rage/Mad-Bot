...
module.exports = class Card {
    ...
    */
    ...
    async toCard() {
        ...
        const status = (this.guild.members.cache.get(this.user.id).presence === null || this.guild.members.cache.get(this.user.id).presence === undefined) ? "offline" : this.guild.members.cache.get(this.user.id).presence.status;
